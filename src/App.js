          ...
          <div className="list">
            <div className="lidiv">
              <div className="li">
                ...
                <div className="far fa-eye view" >{convert(28914)}</div>
              </div>
              <div className="li">
                <img src="https://avatar-nct.nixcdn.com/mv/2018/11/02/8/2/6/0/1541143152870_640.jpg"></img>
                <div className="text">Cho Em Thêm Một Lần<br></br> <strong>Kim Thành</strong></div>
                <div className="number">3:23</div>
                <div className="far fa-eye view">{convert(12345)}</div>
              ...
              {this.state.data.map((obj, index) => {
                return <div className="tiny">
                  <div className="up">
                    ...
                    <div className="far fa-eye view1">{convert(obj.view)}</div>
                  </div>
                  <div className="down">
                    <h3>{obj.h3}</h3>
                    <h4>{obj.h4}</h4>
